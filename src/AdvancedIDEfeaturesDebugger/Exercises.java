package AdvancedIDEfeaturesDebugger;
...
//        exercise2();
    ...
    private static int calculateFactorial(int number) {
        //Fix this code
        int result = 1;
        for (int i = number; i >= 1; i -= 1) { //i-=2 -> i-=1
            result = result * i;
        }
        return result;
    }
    ...
    private static String reverseString(String input) {
        ...
        String reversed = "";
        for (int i = input.length() - 1; i >= 0; i--) { //i >= 1 -> i>=0
    ...
    private static void exercise3() {
        ...
        Assertions.assertTrue(isPositive(0)); //assertFalse-> assertTrue
