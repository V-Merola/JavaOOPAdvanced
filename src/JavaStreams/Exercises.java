...
public class Exercises {
    ...
    private static void exercise1() {
        System.out.println("\nExercise 1: ");
        // Your code here
        ourNumbers.stream().filter(evenNumber -> evenNumber % 2 == 0).forEach(System.out::println);
    }
    ...
    private static void exercise2() {
        System.out.println("\nExercise 2: ");
        // Your code here
        Set<Integer> oddNumbers = ourNumbers.stream().filter(oddNumber -> oddNumber % 2 != 0).collect(Collectors.toSet());
    ...
    private static void exercise4() {
        System.out.println("\nExercise 4");
        //Your code here
        Set<Integer> evenNumbers = ourNumbers.stream().filter(oddNumber -> oddNumber % 2 == 0).map(odd -> odd * 2).collect(Collectors.toSet());
