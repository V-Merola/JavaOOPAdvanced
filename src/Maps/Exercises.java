...
public class Exercises {
    ...
    private static void exercise1() {
        ...
        myFirstMap.put(1, "Vincenzo");
        myFirstMap.put(3, "Merola");
        myFirstMap.put(9, "Develhope");
        // 1c. Print the map
        System.out.println(myFirstMap);
        // 1d. Access an element in the map with .get
        System.out.println(myFirstMap.get(3));
    ...
    private static void exercise2() {
        ...
        System.out.println("Most expensive menu : " + mostExpensiveMenuItemName);
