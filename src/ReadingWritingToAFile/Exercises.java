...
public class Exercises {
    ...
    private static final Path PATH_IN_A_FOLDER = Paths.get("ReadingWritingToAFile/file.txt");
    ...
    private static void exercise3() {
        ...
        try {
            // Your code here
            System.out.println(Arrays.stream(Files.readString(MY_PATH).split("\n")).count());
    ...
    private static void exercise4() {
        ...
        try {
            // Your code here
            System.out.println(Arrays.stream(Files.readString(MY_PATH).split(" ")).count());
    ...
    private static void exercise5() {
        System.out.println("\nExercise 5: ");
        Path myDirectoryPath = Path.of("ReadingWritingToAFile");
